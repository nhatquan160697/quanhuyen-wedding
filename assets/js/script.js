(function ($) {
  ...
  $(document).on("click", ".btn-see-more-gallery", function (e) {
    ...
    // Check if photoGalleries is defined and not empty
    if (typeof photoGalleries === 'undefined' || !Array.isArray(photoGalleries) || photoGalleries.length === 0) {
      console.warn('photoGalleries is not defined or empty');
      return;
    }
